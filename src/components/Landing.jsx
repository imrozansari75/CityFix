...
import {Shield, MapPin, Users, Car, Lightbulb, Trash2, FileEdit, CheckCircle2, Camera, Upload, RefreshCw, Smartphone, Settings, Check, Twitter, Facebook, Instagram, Linkedin} from "lucide-react";
    ...
    <div className="min-h-screen bg-white text-gray-900">
        ...
        <div>
          ...
          <div className="flex gap-4 mb-10">
            <button className="flex items-center gap-2 bg-blue-600 text-white px-5 py-3 rounded-lg hover:bg-blue-700">
              <FileEdit size={18} /> Report an Issue
            </button>
          ...
          <div className="flex gap-10 text-sm">
            <Feature icon={<Shield size={20} className="text-blue-600" />} title="Fast Reporting" subtitle="Report in seconds" />
            <Feature icon={<RefreshCw size={20} className="text-green-600" />} title="Real-time Tracking" subtitle="Stay updated" />
            <Feature icon={<Users size={20} className="text-purple-600" />} title="Community Driven" subtitle="Stronger together" />
          </div>
        </div>
      ...
      <section className="bg-gray-50 px-8 py-16 text-center">
        ...
        <div className="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto">
          <ProblemCard
            icon={<Car size={28} className="text-red-500" />}
            bg="bg-red-50"
            title="Damaged Roads"
          ...
          />
          <ProblemCard
            icon={<Trash2 size={28} className="text-green-500" />}
            bg="bg-green-50"
            title="Garbage & Waste"
      ...
      <section id="how" className="bg-indigo-50 px-8 py-16 text-center">
        ...
        <div className="flex flex-col md:flex-row items-center justify-center gap-6 md:gap-4 max-w-4xl mx-auto">
          ...
          <Step
            ...
            icon={<CheckCircle2 size={28} className="text-purple-600" />}
